...
def main():
    ...
    test_agents = [
        ...
        Agent(AlphaBetaPlayer(score_fn=custom_score_2), "custom2"),
        #Agent(AlphaBetaPlayer(score_fn=custom_score_3), "custom3"),
        #Agent(AlphaBetaPlayer(score_fn=custom_score_5), "custom4"),
